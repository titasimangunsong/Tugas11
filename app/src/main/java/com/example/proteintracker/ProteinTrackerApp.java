...
public class ProteinTrackerApp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnCustom = (Button)findViewById(R.id.btnCustomDialog);
        btnCustom.setOnClickListener(btnCustomListener);
    ...
    private View.OnClickListener btnCustomListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
